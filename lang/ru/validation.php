<?php
    ...
    'custom' => [
        'agree_policy' => [
            'accepted' => 'Необходимо дать согласие на обработку персональных данных.'
        ],
        'attribute-name' => [
            'rule-name' => null
        ]
    ...
    'declined' => 'Поле :attribute должно быть отключено.',
    'declined_if' => 'Поле :attribute должно быть отключено, когда :other равно :value.',
    'enum' => 'Выбранный элемент :attribute неверный.',
    'mac_address' => 'Поле :attribute должно быть правильным MAC адресом.',
    'multiple_of' => 'Поле :attribute должно иметь несколько значений :value.',
