...
@section('title', 'Новости - SOCNET SMM')
    ...
    <div class="news-list-page">
        ...
        <section class="news-header-section">
            <div class="container">
                ...
                <div class="news-header-content">
                    ...
                    <h1 class="news-title">Новости и блог</h1>
        ...
        <section class="news-list-section">
            ...
            <div class="container">
                ...
                <!-- Pagination -->
                <div class="pagination-container" id="newsPagination">
                ...
                <div class="related-news-body">
                    <div class="related-news-slider swiper">
                        <div class="swiper-wrapper">
                            @foreach ($newsList as $news)
                                <a href="{{ route('news.show', $news['slug']) }}" class="related-news-item news-list-card swiper-slide">
                                    <div class="news-list-image">
                                        <img src="{{ asset($news['image']) }}" alt="{{ $news['title'] }}">
                                    </div>
                                    <div class="news-list-content">
